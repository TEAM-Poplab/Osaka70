...
public class FreezeGeometries : Singleton<FreezeGeometries>, MATKPointerResponder
{
    ...
    protected Dictionary<int, GameObject> originalGeometries = new Dictionary<int, GameObject>();
    ...
    public virtual void FreezeGeometry(GameObject instantiatedObjectOrigin)
    {
        if (instantiatedObjectOrigin != null)
        {
            ...
            originalGeometries.Add(obj.GetInstanceID(), platformDock.PlatformedObject.transform.parent.gameObject);
    ...
    public virtual void UnfreezeGeometry(GameObject frozenGeometry)
    {
        ...
        originalGeometries[frozenGeometryOrigin.GetInstanceID()].SetActive(true); //The original object must implements its own behaviour when enabled again
        originalGeometries.Remove(frozenGeometryOrigin.GetInstanceID());
    ...
    {
        originalGeometries.Add(objectToAdd.GetInstanceID(), objectToAdd);
    }
